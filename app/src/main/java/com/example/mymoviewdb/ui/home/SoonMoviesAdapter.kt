...
class SoonMoviesAdapter(
    private val data: List<ResultCominSoon>,
    private val listener: (ResultCominSoon) -> Unit)
    : RecyclerView.Adapter<SoonMoviesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: SoonMoviesAdapter.ViewHolder, position: Int) {
...
//        private val tvRate: TextView = view.findViewById(R.id.tvRate)
        ...
        fun bindItem(data: ResultCominSoon, listener: (ResultCominSoon) -> Unit, context: Context) {
